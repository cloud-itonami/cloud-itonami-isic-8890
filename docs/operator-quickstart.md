...
Shortest path from clone to a verified local dry-run for **ISIC 8890** (`cloud-itonami-isic-8890`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8890.git
cd cloud-itonami-isic-8890
```
...
- Blueprint governor key: `social-services-governor`
- Likely source path: `casework.governor.cljc`
