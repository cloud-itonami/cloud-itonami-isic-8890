...
Participants should communicate respectfully, assume good intent when
possible, and focus disagreement on facts, design, safety and user impact.
...
patient, resident or client data.

## Enforcement

Maintainers may remove comments, reject contributions or restrict
participation when behavior puts contributors, users, operators or data
subjects at risk.
